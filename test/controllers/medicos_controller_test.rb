...
class MedicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medico" do
    assert_difference('Medico.count') do
      post medicos_url, params: { medico: { age: @medico.age, cpf: @medico.cpf, first_name: @medico.first_name, last_name: @medico.last_name } }
    end
  ...
  test "should update medico" do
    patch medico_url(@medico), params: { medico: { age: @medico.age, cpf: @medico.cpf, first_name: @medico.first_name, last_name: @medico.last_name } }
